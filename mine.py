...
app.config['SECRET_KEY'] = '123user_key!321'
...
def register():
    if request.method == 'POST':
        ...
        try:
            ...
            connection.commit()
            print('Registrasion is great!')
        except sqlite3.IntegrityError:
            return render_template('register.html',
                                   message='К моему великому сожелению, уважаемый пользователь но такое имя занял другой много уважаемый сударь и к не счастью для вас с меня вам предстоит вспомнить весь алфавит каторый выглядит следующим оброзам: Аа Бб Вв Гг Дд Ее Ёё Жж Зз Ии Йй Кк Лл Мм Нн Оо Пп Рр Сс Тт Уу Фф Хх Цц Чч Шш Щщ Ьь Ъъ Ыы Ээ Юю Яя. И теперь вспомнив его вы можете придумать и написать ЧТО угодно! Удачи:^)')
    return render_template('register.html')
